...
const navGroups = [
  ...
  {
    // The rest of the accounting surface lives behind its own tabbed hub
    // (/accounting) instead of a dozen flat sidebar links. Reports gets a
    // direct link too since it's the one people check most often.
    label: "Books",
    items: [
